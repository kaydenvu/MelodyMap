...
.image-container {
  ...
  align-items: center;
  overflow: hidden;
  height: 100%; /* Ensure the height matches the text container */
}

.image-container img {
    width: 100%;
    height: 100%;
    object-fit: cover; /* Ensure the entire image fits inside the container */
}
...
.info-container {
  ...
  justify-content: center;
  align-items: center;
  height: 100%; /* Ensure the height matches the image container */
  }
